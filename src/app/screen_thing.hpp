...
public:
  ...
  void buildHomeScreen() {
    ...
    screen->addWidget(widgetFactory->createButton("Mario Kart 64"));
    screen->addWidget(widgetFactory->createButton("Paper Mario"));
    screen->addWidget(widgetFactory->createButton("Pokemon Red Version"));
    screen->addWidget(widgetFactory->createButton("Pokemon Yellow Version"));
    screen->addWidget(widgetFactory->createButton("Super Mario World"));
